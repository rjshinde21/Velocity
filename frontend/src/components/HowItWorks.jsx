...
const HowItWorks = () => {
  ...
  <div className="relative w-full px-4 sm:px-6 lg:px-10 py-16 sm:py-20"> {/* Reduced py-32 to py-16 sm:py-20 */}
    <div className="max-w-7xl mx-auto flex flex-col items-center lg:flex-row lg:justify-between gap-10">
      ...
      <div className="w-full lg:w-1/2 px-4">
        ...
        <div className="flex flex-col items-center space-y-4 w-full lg:w-3/4 pt-8"> {/* Reduced pt-10 to pt-8 */}
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center px-4">
        <div className="w-full max-w-2xl pt-8"> {/* Reduced pt-16 to pt-8 */}
