...
const Carousel = ({ speed = 30000 }) => {
  ...
  <div className="relative min-h-[400px] md:min-h-[300px] lg:min-h-[200px] w-full py-16">
    ...
    <div className="relative h-full w-full max-w-6xl mx-auto px-4 md:px-6 lg:px-8 flex flex-col justify-center items-center py-8 md:py-12">
      ...
      <button
        ...
        <div className="bg-[#121212] backdrop-filter backdrop-blur-SM bg-opacity-90 bg-noise   rounded-2xl md:rounded-[30px] p-4 sm:p-6 md:p-8 lg:p-10 mx-auto shadow-lg w-full sm:w-[80%] md:w-[70%] lg:w-[60%]">
  ...
  <div className="wrapper row1 flex gap-2 sm:gap-4">
    <section
  ...
  <div className="wrapper row2 flex gap-2 sm:gap-4">
    <section
      className="flex gap-2 sm:gap-4"
      style={{ "--speed": `${speed}ms`, width: "100%" }}
    >
